...
import { GetAllImageApi, GetDetailModelApi, GetListModelsApi } from '../../api/usersApi';
...
function Management() {
  ...
  const handleChangeMFG = (e) => {
    setDataSearch({
      mfg_no: e.target.value,
      model_name: dataSearch.model_name,
      send_date: dataSearch.send_date,
      status: dataSearch.status
    })
  }
  const handleChangeModelName = (e) => {
    setDataSearch({
      mfg_no: dataSearch.mfg_no,
      model_name: e.target.value,
      send_date: dataSearch.send_date,
      status: dataSearch.status
    })
  }
  const handleChangeSentDate = (e) => {
    setDataSearch({
      mfg_no: dataSearch.mfg_no,
      model_name: dataSearch.model_name,
