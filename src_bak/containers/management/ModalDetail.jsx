...
function ModalDetail({ open, close, dataRecord }) {
  ...
  let nameCollapse = ['製造情報', 'ポンプ情報', 'モーター情報', '前回チェック情報', '特記事項']
  ...
  const Controls = () => {
    ...
    return (
      <>
        ...
        >
          <Col span={5} style={{ display: "flex", alignItems: "center" }}><Button onClick={() => resetTransform()} className='btn-reset'><img style={{ cursor: "pointer", width: 16, height: 16 }} src={ResetSizeImage} alt='' /></Button></Col>
          {/* <button onClick={changeValue}>123</button> */}
                    ...
                    <>
                      ...
                      <TransformComponent contentStyle={{ cursor: 'zoom-in', width: "100%", display: "flow", padding: "1% 1% 2%" }}>
                        ...
                        <img
                          ...
                          style={{ width: "100%", height: "auto", maxHeight: "86vh", filter: "drop-shadow(2px 4px 6px black)", imageRendering: "unset" }}
                          alt="Zoomable"
                        />
                      </TransformComponent>
                    </>
